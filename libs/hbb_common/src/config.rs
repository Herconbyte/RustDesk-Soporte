...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("Soporte Herconbyte".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["soporte.herconbyte.com.ar"];
pub const RS_PUB_KEY: &str = "hP6kEXdyMUxYSie5U3gYKbXqywJ2NQZ3RxNHkn2c6E4=";
    ...
    pub fn get(&self, key: &str) -> String {
        match key {
            ...
            keys::OPTION_IMAGE_QUALITY => {
                self.get_string(key, "low", vec!["balanced", "best", "custom"])
            }
